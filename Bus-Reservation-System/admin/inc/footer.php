    ...
    <div class="row">
        <div class="col-lg-4 p-4">
            ...
            <p>
                ...
                Facilis error ducimus voluptatibus doloremque
                quod vel debitis corrupti itaque fugiat tenetur.
            </p>
        </div>
        <div class="col-lg-4 p-4">
            <h5 class="mb-3 h-font">Links</h5>
            <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Home</a><br>
            <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Buses</a><br>

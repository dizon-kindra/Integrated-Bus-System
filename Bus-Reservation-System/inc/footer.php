...
<div class="container-fluid bg-white mt-5">
    <div class="row">
        ...
        <div class="col-lg-4 p-4">
            ...
            <a href="index.php#searchTrip" class="d-inline-block mb-2 text-dark text-decoration-none">Search Trips</a><br>
            <a href="bookings.php" class="d-inline-block mb-2 text-dark text-decoration-none">My Bookings</a><br>
            <a href="index.php#contactus" class="d-inline-block mb-2 text-dark text-decoration-none">Contact Us</a><br>
        </div>
...
<h6 class="text-center bg-dark text-white p-3 m-0 h-font">Designed and Developed by MYBUS</h6>

...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font chover" href="index.php">MYBUS</a>
            ...
            if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
                echo <<<data
                    <div class="d-flex align-items-center">
                        <a href="profile.php" class="btn btn-outline-dark shadow-none me-lg-3 me-2 h-font">Profile</a>
                        <form method="POST" action="logout.php" class="m-0">
                            <button type="submit" class="btn btn-dark shadow-none h-font">Logout</button>
                        </form>
                    </div>
                data;
            } else {
                echo <<<data
                    <div class="d-flex">
                        ...
                        <button class="btn btn-dark shadow-none h-font" data-bs-toggle="modal" data-bs-target="#registerModal">Register</button>
                    </div>
                data;
            }
            ?>
        ...
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            <form id="login_form" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <button type="submit" class="btn btn-dark shadow-none w-100 py-2">Login</button>
            ...
            <form id="register_form" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="register_email" name="email" class="form-control shadow-none"
                            placeholder="Enter your email" required>
                    </div>

                    <div class="mb-3">
                        <label for="phonenum" class="form-label fw-bold">Phone Number</label>
                        <input type="tel" id="phonenum" name="phonenum" class="form-control shadow-none"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="register_pass" name="pass" class="form-control shadow-none"
                    ...
                    <button type="submit" class="btn btn-dark shadow-none w-100 py-2">Register</button>
